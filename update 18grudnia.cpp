...
zwierze::zwierze(float x_in1, float y_in1)
{
	...
	tekstura1.loadFromFile("dzik.jpg");
...
x2:
	...
	if (punktyRozgrywkiTotal >= minPoints)
	{
		...
		Sleep(2250);
		system("cls");
		cout << "Sam przekonales sie  na czym polega gra a wiec wiesz czego mozesz sie spodziewac...." << endl;
		Sleep(2000);
		cout << "pewnie wiesz ,ze nie bedzie latwo... zatem pozwole CI wybrac ulatwienie rozgrywki..." << endl;
		Sleep(2000);
		cout << "Mozesz sobie lekko pomoc wybierajac stopien trudnosci gry..." << endl;
		Sleep(2500);
		system("cls");*/
		j:
		cout << "Wybiersz stopien trundosci: " << endl;
		cout << "( numerek 1)     Poziom latwy , mnoznik x5 "  << endl;
		cout << "( numerek 2)     Poziom eksperymentalny , mnoznik x2" << endl;
		cout << "( numerek 3)     Poziom trudny , mnoznik x1" << endl;
		cout << "( numerek 4)     Poziom legendarny , mnoznik x0.5" << endl;
		cout << "( numerek 5)     Poziom piekielny , poziom x0.1" << endl;
		cout << "Wpisz jaki poziom chcesz wybrac... "<< endl;
		float wybor;
		cin >> wybor;
		float wyborRezultat ;
		if (wybor == 1)
		...
		system("cls");
		cout << "Wybrano opcje numer: " << wybor << endl;
		cout << "Zdobyles: " << punktyRozgrywkiTotal << "punktow" << endl;
		Sleep(2000);
		
		mnoznik = wyborRezultat * punktyRozgrywkiTotal*0.001 ;
		cout << "Oznacza to ,ze twoj mnoznik punktow wynosi:   x" << mnoznik << "" << endl;
		Sleep(3000);
		system("cls");
	...
	{
		cout << "Niesty nie udalo Ci sie zdobyc wystarczajaco duzo punktow pierszym etapie..." << endl;
		Sleep(2000);
		system("cls");
		cout << " Nie mozesz przejsc do etapu 2...." << endl;
		Sleep(2000);
		system("cls");
		cout << "Na tym twoja rozgrywka sie konczy :(" << endl;
		Sleep(2000);
		return 0;
	}
